...
public class MainTest {
	...
	public static void main(String[] args) {
		...
		ExecutionManager.processArrayOfType(500000, 2, "500000-AlmostSorted-2");
		System.out.println("500000 Almost Sorted 2 done");
		ExecutionManager.processArrayOfType(500000, 3, "500000-AlmostSorted-3");
		System.out.println("500000 Almost Sorted 3 done");
		ExecutionManager.processArrayOfType(500000, 4, "500000-AlmostSorted-4");
		System.out.println("500000 Almost Sorted 4 done");
		ExecutionManager.processArrayOfType(500000, 5, "500000-AlmostSorted-5");
		System.out.println("500000 Almost Sorted 5 done");
		ExecutionManager.processArrayOfType(500000, 6, "500000-ReverseSorted");
		System.out.println("500000 Finished 100000");

		ExecutionManager.processArrayOfType(1000000, 0, "1000000-Random");
		System.out.println("1M : Random done");
		ExecutionManager.processArrayOfType(1000000, 1, "1000000-AlmostSorted-1");
		System.out.println("1M : Almost Sorted 1 done");
		ExecutionManager.processArrayOfType(1000000, 2, "1000000-AlmostSorted-2");
		System.out.println("1M : Almost Sorted 2 done");
		ExecutionManager.processArrayOfType(1000000, 3, "1000000-AlmostSorted-3");
		System.out.println("1M : Almost Sorted 3 done");
		ExecutionManager.processArrayOfType(1000000, 4, "1000000-AlmostSorted-4");
